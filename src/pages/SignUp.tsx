    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary p-12 items-center justify-center">
        <div className="text-primary-foreground text-center max-w-lg">
          ...
          <h1 className="text-4xl font-bold mb-6">Join AI Dropship</h1>
          <p className="text-xl opacity-90 leading-relaxed">
            Start your dropshipping journey with AI-powered insights and data-driven decisions.
          </p>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="terms" className="text-sm">
                  I agree to the <button type="button" className="text-primary hover:underline">Terms & Conditions</button>
                </Label>
              </div>
